...
const QuickExerciseCard = () => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="relative overflow-hidden rounded-[20px] bg-gradient-to-br from-secondary-light to-surface p-6 shadow-sm border border-secondary/30 transition-all"
    >
      <motion.div
      ...
      <div className="relative z-10 flex flex-col h-full">
        <h3 className="text-[16px] font-bold text-text-main mb-2">Feeling Overwhelmed?</h3>
        <p className="text-[13px] text-text-muted leading-relaxed mb-4 flex-grow">
