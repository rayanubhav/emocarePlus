...
const Breathing = () => {
  ...
  return (
    <div className="bg-surface border border-border rounded-[24px] overflow-hidden shadow-[0_2px_20px_rgba(91,155,213,0.08)]">
        ...
        {!isPlaying ? (
          <motion.div key="settings" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col">
            ...
            <div className="py-12 px-6 flex flex-col items-center justify-center gap-8">
              ...
              />
              <h3 className="text-[22px] font-semibold text-text-muted tracking-tight">{instruction}</h3>
          ...
          <motion.div key="player" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col">
            ...
            <div className="py-12 px-6 flex flex-col items-center justify-center gap-8 min-h-[300px]">
              ...
              <AnimatePresence mode="wait">
                <motion.h3 key={instruction} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-[22px] font-semibold text-text-main tracking-tight text-center h-8">
                  {instruction}
                </motion.h3>
              </AnimatePresence>
              <button onClick={stopExercise} className="w-[60px] h-[60px] rounded-full bg-error-bg text-error border-[1.5px] border-error flex items-center justify-center shadow-[0_4px_12px_rgba(192,80,77,0.12)] hover:bg-[#F5D0D0] transition-colors">
